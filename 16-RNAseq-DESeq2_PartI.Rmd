...
```{r}
raw_counts <- read.csv("raw_counts.csv", header = T, 
...
#2 Filter count file accordingly (to keep only samples present in the filtered xp_design file)
...
### Extracting the table of differential genes Ok, here's the moment you've been waiting for. How can I extract a nicely filtered final table of differential genes? Here it is!
