...
as the one we observed only 1.5% of the time. This is what is known as a p-value, which we will define more formally later in the book. 

We typically however don't have access to the population, so we need other ways of calculating p-values.
