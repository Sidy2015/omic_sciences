...
handling and annotating genomic sequence. The Rmd for this
file can be found [here](https://github.com/gurinina/omic_sciences/blob/main/09-annotation.Rmd). We'll look at
...
```
```{r lkt}
select(org.Hs.eg.db, keys="ORMDL3", keytype="SYMBOL", 
   columns="GENENAME")
```
The format is:
