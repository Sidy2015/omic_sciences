...
kable(d, caption = 'Pseudo-referance sample') %>%
...
kable(d2, caption = 'ratio of each sample to the reference') %>%
   kable_styling(full_width = FALSE, 
                 latex_options = c('hold_position', 'striped','scale_down'),
                 position = "center",
                 font_size = 12)
...
kable(d3, caption = 'Normalized Counts') %>%
   kable_styling(full_width = FALSE, 
                 latex_options = c('hold_position', 'striped','scale_down'),
                 position = "center",
                 font_size = 12)
