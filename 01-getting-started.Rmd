...
help as we will dive into thihgs pretty quickly.

## Installing materical for course from Github 

What is Github? Github is a system used for version control. It's fairly
sophisticated and we are not going to learn a lot about it here but it is well
...
To clone a repository, where you just want a copy of someone else's 
repository your create a new RStudio Project from this GitHub repo.

In RStudio, start a new Project:

File > New Project > Version Control > Git. In the “repository URL” paste the URL of your new GitHub repository. It will be  https://github.com/gurinina/omic_sciences
...
This should be all you need to have the course material in this project.
