...
To clone thr course repository so that you get your own copy in Rstudio, you create a new RStudio Project from this GitHub repo.
...
This should copy all of be the course material into this project and should be all you need for the course.
